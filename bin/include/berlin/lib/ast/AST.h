...
#define INCLUDED_berlin_lib_ast_AST

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(berlin,lib,ast,AST)
...
class HXCPP_CLASS_ATTRIBUTES AST_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x4e4df47b };

		void __construct(::String val);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="berlin.lib.ast.AST")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"berlin.lib.ast.AST"); }
...
#endif /* INCLUDED_berlin_lib_ast_AST */ 
