...
HX_DEFINE_STACK_FRAME(_hx_pos_9a0e0835a3d6f0c7_24_new,"berlin.lib.AST","new",0x631165df,"berlin.lib.AST.new","berlin/lib/AST.hx",24,0xe0da1c73)
HX_LOCAL_STACK_FRAME(_hx_pos_9a0e0835a3d6f0c7_32_EMPTY,"berlin.lib.AST","EMPTY",0xab35a5ac,"berlin.lib.AST.EMPTY","berlin/lib/AST.hx",32,0xe0da1c73)
HX_LOCAL_STACK_FRAME(_hx_pos_9a0e0835a3d6f0c7_37_TREE,"berlin.lib.AST","TREE",0x3ae99aff,"berlin.lib.AST.TREE","berlin/lib/AST.hx",37,0xe0da1c73)
namespace berlin{
namespace lib{
...
bool AST_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1191be67;
}

 ::berlin::lib::AST AST_obj::EMPTY(){
            	HX_GC_STACKFRAME(&_hx_pos_9a0e0835a3d6f0c7_32_EMPTY)
HXDLIN(  32)		return  ::berlin::lib::AST_obj::__alloc( HX_CTX ,HX_("EMPTY",6d,72,c8,ed),null(),null());
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(AST_obj,EMPTY,return )

 ::berlin::lib::AST AST_obj::TREE( ::Dynamic str, ::Dynamic asts){
            	HX_GC_STACKFRAME(&_hx_pos_9a0e0835a3d6f0c7_37_TREE)
HXDLIN(  37)		return  ::berlin::lib::AST_obj::__alloc( HX_CTX ,HX_("TREE",5e,61,c4,37),str,asts);
            	}
...
void AST_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("berlin.lib.AST","\x6d","\x8a","\x1b","\x8c");
