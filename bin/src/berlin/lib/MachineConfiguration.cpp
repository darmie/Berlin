...
HX_DEFINE_STACK_FRAME(_hx_pos_c8a4c82961c88f0e_21_new,"berlin.lib.MachineConfiguration","new",0x52562816,"berlin.lib.MachineConfiguration.new","berlin/lib/MachineConfiguration.hx",21,0x0cd2a7d8)
HX_LOCAL_STACK_FRAME(_hx_pos_c8a4c82961c88f0e_38_EVAL,"berlin.lib.MachineConfiguration","EVAL",0x9de79b26,"berlin.lib.MachineConfiguration.EVAL","berlin/lib/MachineConfiguration.hx",38,0x0cd2a7d8)
HX_LOCAL_STACK_FRAME(_hx_pos_c8a4c82961c88f0e_44_APPLY,"berlin.lib.MachineConfiguration","APPLY",0x3b39ee84,"berlin.lib.MachineConfiguration.APPLY","berlin/lib/MachineConfiguration.hx",44,0x0cd2a7d8)
namespace berlin{
namespace lib{

void MachineConfiguration_obj::__construct(::String type, ::berlin::lib::Exp exp,int pos,::Array< ::Dynamic> asts, ::Dynamic err,::Array< ::Dynamic> continuations, ::berlin::lib::Value value){
            	HX_STACKFRAME(&_hx_pos_c8a4c82961c88f0e_21_new)
...
HXLINE(  30)		::berlin::lib::Assert_obj::ok(::Std_obj::is(this->asts,hx::ArrayBase::__mClass));
HXLINE(  31)		::berlin::lib::Assert_obj::ok(::Std_obj::is(this->continuations,hx::ArrayBase::__mClass));
HXLINE(  32)		::berlin::lib::Assert_obj::ok(::Std_obj::is(pos,hx::ClassOf< int >()));
            	}
...
bool MachineConfiguration_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x4f2a49b2;
}

 ::berlin::lib::MachineConfiguration MachineConfiguration_obj::EVAL( ::berlin::lib::Exp exp,int pos,::Array< ::Dynamic> asts, ::Dynamic err,::Array< ::Dynamic> continuations){
            	HX_GC_STACKFRAME(&_hx_pos_c8a4c82961c88f0e_38_EVAL)
HXDLIN(  38)		return  ::berlin::lib::MachineConfiguration_obj::__alloc( HX_CTX ,HX_("EVAL",9c,33,dd,2d),exp,pos,asts,err,continuations,null());
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC5(MachineConfiguration_obj,EVAL,return )

 ::berlin::lib::MachineConfiguration MachineConfiguration_obj::APPLY(::Array< ::Dynamic> continuations, ::berlin::lib::Value value){
            	HX_GC_STACKFRAME(&_hx_pos_c8a4c82961c88f0e_44_APPLY)
HXDLIN(  44)		return  ::berlin::lib::MachineConfiguration_obj::__alloc( HX_CTX ,HX_("APPLY",4e,bd,29,a2),null(),(int)0,null(),null(),continuations,value);
            	}
...
hx::ObjectPtr< MachineConfiguration_obj > MachineConfiguration_obj::__new(::String type, ::berlin::lib::Exp exp,int pos,::Array< ::Dynamic> asts, ::Dynamic err,::Array< ::Dynamic> continuations, ::berlin::lib::Value value) {
...
hx::ObjectPtr< MachineConfiguration_obj > MachineConfiguration_obj::__alloc(hx::Ctx *_hx_ctx,::String type, ::berlin::lib::Exp exp,int pos,::Array< ::Dynamic> asts, ::Dynamic err,::Array< ::Dynamic> continuations, ::berlin::lib::Value value) {
	MachineConfiguration_obj *__this = (MachineConfiguration_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(MachineConfiguration_obj), true, "berlin.lib.MachineConfiguration"));
...
hx::Val MachineConfiguration_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"value") ) { value=inValue.Cast<  ::berlin::lib::Value >(); return inValue; }
		break;
	case 13:
...
static hx::StorageInfo MachineConfiguration_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::berlin::lib::Exp*/ ,(int)offsetof(MachineConfiguration_obj,exp),HX_HCSTRING("exp","\x9d","\x0c","\x4d","\x00")},
	...
	{hx::fsObject /*::berlin::lib::Value*/ ,(int)offsetof(MachineConfiguration_obj,value),HX_HCSTRING("value","\x71","\x7f","\xb8","\x31")},
	{ hx::fsUnknown, 0, null()}
};
...
void MachineConfiguration_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("berlin.lib.MachineConfiguration","\x24","\x25","\x37","\xbe");
