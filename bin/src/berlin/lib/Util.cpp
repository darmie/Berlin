...
HX_DEFINE_STACK_FRAME(_hx_pos_fc1f1680195ae410_14_new,"berlin.lib.Util","new",0x0e6c9ee9,"berlin.lib.Util.new","berlin/lib/Util.hx",14,0x8fac5065)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1f1680195ae410_17_arrayPrepend,"berlin.lib.Util","arrayPrepend",0x2c77becc,"berlin.lib.Util.arrayPrepend","berlin/lib/Util.hx",17,0x8fac5065)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1f1680195ae410_30_uniq,"berlin.lib.Util","uniq",0x9545b3d8,"berlin.lib.Util.uniq","berlin/lib/Util.hx",30,0x8fac5065)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1f1680195ae410_44_getLineCol,"berlin.lib.Util","getLineCol",0x07ae1b4d,"berlin.lib.Util.getLineCol","berlin/lib/Util.hx",44,0x8fac5065)
static const ::String _hx_array_data_194ef677_6[] = {
	HX_("\r",0d,00,00,00),HX_("\n",0a,00,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_fc1f1680195ae410_71_first,"berlin.lib.Util","first",0x616dbaf9,"berlin.lib.Util.first","berlin/lib/Util.hx",71,0x8fac5065)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1f1680195ae410_79_rest,"berlin.lib.Util","rest",0x9343446b,"berlin.lib.Util.rest","berlin/lib/Util.hx",79,0x8fac5065)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1f1680195ae410_90_updateError,"berlin.lib.Util","updateError",0x648a3488,"berlin.lib.Util.updateError","berlin/lib/Util.hx",90,0x8fac5065)
namespace berlin{
namespace lib{
...
bool Util_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2c3cee21;
}

 ::Dynamic Util_obj::arrayPrepend( ::Dynamic item, ::Dynamic a){
            	HX_STACKFRAME(&_hx_pos_fc1f1680195ae410_17_arrayPrepend)
...
::cpp::VirtualArray Util_obj::uniq(::cpp::VirtualArray x){
            	HX_STACKFRAME(&_hx_pos_fc1f1680195ae410_30_uniq)
...
::Array< int > Util_obj::getLineCol(int pos,::String input){
            	HX_STACKFRAME(&_hx_pos_fc1f1680195ae410_44_getLineCol)
...
HXLINE(  53)				::Array< ::String > rn = ::Array_obj< ::String >::fromData( _hx_array_data_194ef677_6,2);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Util_obj,getLineCol,return )
 ...
 ::Dynamic Util_obj::first(::cpp::VirtualArray a){
            	HX_STACKFRAME(&_hx_pos_fc1f1680195ae410_71_first)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Util_obj,first,return )
 ...
 ::Dynamic Util_obj::rest(::cpp::VirtualArray a){
            	HX_STACKFRAME(&_hx_pos_fc1f1680195ae410_79_rest)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Util_obj,rest,return )
 ...
 ::berlin::lib::RawError Util_obj::updateError( ::berlin::lib::RawError err,int pos, ::Dynamic e){
            	HX_GC_STACKFRAME(&_hx_pos_fc1f1680195ae410_90_updateError)
...
HXLINE(  92)			return  ::berlin::lib::RawError_obj::__alloc( HX_CTX ,pos,::cpp::VirtualArray_obj::__new(1)->init(0,err->currentNT),::cpp::VirtualArray_obj::__new(1)->init(0,e),err->currentNT);
            		}
            		else {
...
HXDLIN( 112)				::cpp::VirtualArray _hx_tmp2 = ( (::cpp::VirtualArray)(::berlin::lib::Util_obj::arrayPrepend(err->currentNT,err->nonterminals)) );
HXDLIN( 112)				::cpp::VirtualArray _hx_tmp3 = ( (::cpp::VirtualArray)(::berlin::lib::Util_obj::arrayPrepend(e,err->failedChars)) );
HXDLIN( 112)				return  ::berlin::lib::RawError_obj::__alloc( HX_CTX ,err1,_hx_tmp2,_hx_tmp3,err->currentNT);
            			}
            			else {
HXLINE( 114)				return  ::berlin::lib::RawError_obj::__alloc( HX_CTX ,err->pos,err->nonterminals,err->failedChars,err->currentNT);
            			}
            		}
...
void Util_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("berlin.lib.Util","\x77","\xf6","\x4e","\x19");
