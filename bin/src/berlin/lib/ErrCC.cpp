...
HX_DEFINE_STACK_FRAME(_hx_pos_0e79851890b51e32_14_new,"berlin.lib.ErrCC","new",0xede5a622,"berlin.lib.ErrCC.new","berlin/lib/ErrCC.hx",14,0x4c45da10)
namespace berlin{
namespace lib{
...
bool ErrCC_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x584280e2;
}
...
void ErrCC_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("berlin.lib.ErrCC","\x30","\xad","\x13","\xd4");
