...
HX_DEFINE_STACK_FRAME(_hx_pos_3012cb73c83cc164_14_new,"lib.ast.AST","new",0x84795d3f,"lib.ast.AST.new","lib/ast/AST.hx",14,0xbc443113)
HX_LOCAL_STACK_FRAME(_hx_pos_3012cb73c83cc164_18_echo,"lib.ast.AST","echo",0x5fc3bd26,"lib.ast.AST.echo","lib/ast/AST.hx",18,0xbc443113)
namespace lib{
namespace ast{

void AST_obj::__construct(::String val){
            	HX_STACKFRAME(&_hx_pos_3012cb73c83cc164_14_new)
...
bool AST_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x5cdbfc25;
}

void AST_obj::echo(){
            	HX_STACKFRAME(&_hx_pos_3012cb73c83cc164_18_echo)
...
hx::ObjectPtr< AST_obj > AST_obj::__alloc(hx::Ctx *_hx_ctx,::String val) {
	AST_obj *__this = (AST_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(AST_obj), true, "lib.ast.AST"));
...
void AST_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("lib.ast.AST","\xcd","\x51","\x9c","\xe9");
