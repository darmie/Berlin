...
class Util
{
	...
	public static function uniq<T>(x:Array<T>):Array<T>
	{
			...
			for (e in x){
				...
				if (r.indexOf(e) == -1){ // you can inline exists yourself if you care much about speed. But then you should consider using hash tables or such
					r.push(e);
				}
			}
			return r;
